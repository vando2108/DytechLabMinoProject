#include "../../header/threadpool/threadpool.h"
#include "../../header/log/log.h"
#include "../../header/utils/utils.h"

namespace ThreadPool {
  CThreadPool::CThreadPool(size_t threadnum, size_t tasknum): m_taskqueue(tasknum), m_hasleader(false) {
